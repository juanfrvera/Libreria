...
typeorm_1.createConnection({
    ...
    var catalog, catalogRepository, _a, all_Catalogs, CatalogsCount;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                catalog = new Catalog_1.Catalog();
                ...
                catalogRepository = connection.getRepository(Catalog_1.Catalog);
                return [4 /*yield*/, catalogRepository.save(catalog)];
            case 1:
                _b.sent();
                console.log('Catalog has been saved' + '\n');
                return [4 /*yield*/, catalogRepository.findAndCount()];
            case 2:
                _a = _b.sent(), all_Catalogs = _a[0], CatalogsCount = _a[1];
